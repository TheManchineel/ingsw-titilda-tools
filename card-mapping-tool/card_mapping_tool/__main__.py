...
class TileType(str, Enum):
    ...
    RedCentralHousingUnitTile = "RedCentralHousingUnitTile"
    BlueCentralHousingUnitTile = "BlueCentralHousingUnitTile"
    GreenCentralHousingUnitTile = "GreenCentralHousingUnitTile"
    YellowCentralHousingUnitTile = "YellowCentralHousingUnitTile"
